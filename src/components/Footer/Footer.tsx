...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center gap-8 sm:gap-12 lg:gap-16 w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-4 lg:gap-12 mt-8 sm:mt-10 px-4 sm:px-8 lg:px-12 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-4 sm:gap-3 w-full">
          ...
          <div className="flex gap-2 sm:gap-3 lg:gap-4 relative -left-2 sm:-left-4">
